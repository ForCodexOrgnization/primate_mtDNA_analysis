...
def main():
 ...
 for sample in samples:
  ...
  for line in open_text(inp):
   ...
   for key,a1,a2 in [('REGION_MATCH','trna_id','trna_id'),('ELEMENT_MATCH','struct_element','struct_element'),('PAIR_TYPE_MATCH','pair_type','pair_type'),('PAIR_STATE_MATCH','pair_state','pair_state'),('PAIR_LOCAL_MATCH','paired_local_pos','paired_local_pos')]:v['MTTRNA_'+key]=compare_values(sr.get(a1) if sr else '.',hr.get(a2) if hr else '.')
