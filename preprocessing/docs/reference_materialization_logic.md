...
Embedded chrM references are extracted from the local WG FASTA and indexed. Independent chrM references are extracted from a local mitochondrion FASTA when possible or downloaded from NCBI nucleotide. DNA Zoo automatic download is not implemented and such rows are flagged for manual review.
